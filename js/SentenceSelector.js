function SentenceSelect() {
    ...
    var nounNum1 = Math.round(Math.random() * (nouns.length - 1));
    var nounNum2 = Math.round(Math.random() * (nouns.length - 1));
    var verbNum = Math.round(Math.random() * (verbs.length - 1));
    var adjectiveNum = Math.round(Math.random() * (adjectives.length - 1));
    var articleNum1 = Math.round(Math.random() * (articles.length - 1));
    var articleNum2 = Math.round(Math.random() * (articles.length - 1));
    var prepositionNum = Math.round(Math.random() * (prepositions.length - 1));
